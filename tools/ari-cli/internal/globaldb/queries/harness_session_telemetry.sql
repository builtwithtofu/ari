...
INSERT INTO harness_session_telemetry (
  session_id, workspace_id, task_id, profile_id, profile_name, harness, model, invocation_class, status,
...
SELECT * FROM harness_session_telemetry
WHERE workspace_id = ?
