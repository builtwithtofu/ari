...
func NewDefaultHarnessRegistry() *HarnessRegistry {
	...
	if err := registry.Register(HarnessNameCodex, func(req HarnessSessionStartRequest, primaryFolder string, sink func(string, []TimelineItem)) (Executor, error) {
		_ = req
		_ = sink
	...
	if err := registry.Register(HarnessNameClaude, func(req HarnessSessionStartRequest, primaryFolder string, sink func(string, []TimelineItem)) (Executor, error) {
		_ = req
		_ = sink
