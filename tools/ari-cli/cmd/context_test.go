...
func TestContextExcerptTailCallsPublicRPC(t *testing.T) {
	...
	swapTestValue(t, &contextEnsureDaemonRunning, func(context.Context, *config.Config) error { return nil })
	swapTestValue(t, &contextTailRPC, func(_ context.Context, _ string, req daemon.ContextExcerptCreateFromTailRequest) (daemon.ContextExcerptResponse, error) {
	...
	out, err := h.execute("context", "excerpt", "tail", "--session", "planner-main", "--last", "10", "--id", "plan-tail")
	if err != nil {
...
func TestContextExcerptShowCallsPublicRPC(t *testing.T) {
	h := newCommandHarness(t)
	swapTestValue(t, &contextEnsureDaemonRunning, func(context.Context, *config.Config) error { return nil })
	swapTestValue(t, &contextGetRPC, func(_ context.Context, _ string, req daemon.ContextExcerptGetRequest) (daemon.ContextExcerptResponse, error) {
	...
	out, err := h.execute("context", "excerpt", "show", "plan-tail")
	if err != nil {
...
func TestContextExcerptRangeCallsPublicRPC(t *testing.T) {
	h := newCommandHarness(t)
	swapTestValue(t, &contextEnsureDaemonRunning, func(context.Context, *config.Config) error { return nil })
	swapTestValue(t, &contextRangeRPC, func(_ context.Context, _ string, req daemon.ContextExcerptCreateFromRangeRequest) (daemon.ContextExcerptResponse, error) {
	...
	out, err := h.execute("context", "excerpt", "range", "--session", "planner-main", "--start", "2", "--end", "7", "--id", "plan-range")
	if err != nil {
...
func TestContextExcerptMessagesCallsPublicRPC(t *testing.T) {
	h := newCommandHarness(t)
	swapTestValue(t, &contextEnsureDaemonRunning, func(context.Context, *config.Config) error { return nil })
	swapTestValue(t, &contextMessagesRPC, func(_ context.Context, _ string, req daemon.ContextExcerptCreateFromExplicitIDsRequest) (daemon.ContextExcerptResponse, error) {
	...
	out, err := h.execute("context", "excerpt", "messages", "--session", "planner-main", "--message-id", "msg-2", "--message-id", "msg-9", "--id", "plan-msgs")
	if err != nil {
